 ...
 */
final class Version20241219113127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ingredient (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, quality DOUBLE PRECISION NOT NULL, unit VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE recipe (id SERIAL NOT NULL, author_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, preparation_time INT NOT NULL, difficulty VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE review (id SERIAL NOT NULL, rating INT NOT NULL, comment TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE step (id SERIAL NOT NULL, description VARCHAR(255) NOT NULL, order_number INT NOT NULL, PRIMARY KEY(id))');
